export const portfolioData = {
  ...
  githubActivity: {
    ...
    stats: [
      { label: 'Active Repositories', value: 14, suffix: '+' },
      { label: 'Live Projects', value: 5, suffix: '+' },
      { label: 'AI Product Experiments', value: 5, suffix: '+' },
      { label: 'Deployment Ready Projects', value: 5, suffix: '+' },
    ],
  },
  portfolioStats: {
    ...
    stats: [
      ...
      { label: 'Development Hours', value: 500, suffix: '+' },
    ],
  },
  projects: [
    {
    ...
    },
    {
      ...
      screenshots: [
        ...
        { src: '/assets/projects/Fit_minds/Fit_minds2.png', label: 'Workout Planner' },
        { src: '/assets/projects/Fit_minds/Fit_minds3.png', label: 'Diet Planner' },
        { src: '/assets/projects/Fit_minds/Fit_minds4.png', label: 'Diet Report' },
        { src: '/assets/projects/Fit_minds/Fit_minds5.png', label: 'Pedometer' },
        { src: '/assets/projects/Fit_minds/Fit_minds6.png', label: 'Health AI' },
      ],
